...
│                              YOUR PROJECT                                    │
│                                                                              │
│   dependencies.json                         Generated Files                  │
│   ┌─────────────────────┐                  ┌──────────────────────────────┐ │
│   │ {                   │     cue-config   │ package.json                 │ │
│   │   "dependencies": [ │────────────────►│ tsconfig.json                │ │
│   │     "ts", "node"    │     generate     │ .gitignore                   │ │
│   │   ]                 │                  └──────────────────────────────┘ │
│   │ }                   │                                                    │
│   └─────────────────────┘                                                    │
│                                                                              │
...
│                                                                              │
│  ┌──────────────────┐  ┌──────────────────┐  ┌──────────────────────────┐  │
│  │   npm/package/   │  │   git/ignore/    │  │      ts/config/          │  │
│  │  ┌────────────┐  │  │  ┌────────────┐  │  │  ┌────────────────────┐  │  │
│  │  │ base.cue   │  │  │  │ base.cue   │  │  │  │ base.json          │  │  │
│  │  │ ts.cue     │  │  │  │ npm.cue    │  │  │  │ lib.json (paths)   │  │  │
│  │  │ node.cue   │  │  │  │ ts.cue     │  │  │  │ ts.json            │  │  │
│  │  │ react.cue  │  │  │  │ node.cue   │  │  │  │ node.json          │  │  │
│  │  │ vite.cue   │  │  │  │ react.cue  │  │  │  │ react.json         │  │  │
│  │  └────────────┘  │  │  └────────────┘  │  │  └────────────────────┘  │  │
│  │       │          │  │       │          │  │           │              │  │
│  │       ▼          │  │       ▼          │  │           ▼              │  │
│  │  CUE Unify ───►  │  │  Concatenate ──► │  │    Extend Chain ───►    │  │
